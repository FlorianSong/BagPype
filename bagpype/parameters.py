...
single_bond_energies = {
    ...
    "O": {
        ...
        "MG": 377,
        "ZN": None,
    },  # MG=O, but here because that's the distance cutoff
    "S": {
        "C": 272,
        "H": 363,
        "F": 284,
...
non_standard_residues = {"ABC": {"C": {"C": 12345678}}}
...
distance_cutoffs = {
    ...
    ("C", "ZN"): 0.00,
    ("CA", "O"): 1.822
    + 0.1,  # ('CA', 'O'): 2.70, # Replaced by corresponding data from Huheey
    ("CA", "N"): 2.45,
    ("CA", "S"): 2.60,
    (
        "CU",
        "N",
    ): 0,  # ('CU', 'N'): 2.20, Currently set to not bond as CU is usually an ion
    (
        "CU",
        "O",
    ): 0,  # ('CU', 'O'): 2.20, Currently set to not bond as CU is usually an ion
    ("CU", "S"): 2.20,
    ("FE", "H"): 1.00,
    ("FE", "N"): 2.40,
    ...
    (
        "K",
        "O",
    ): 0.0,  # ('K', 'O'): 3.10, # Could not find evidence that this exists as a covalent bond.
    ("MG", "MG"): 3.782,
    (
        "MG",
        "N",
    ): 0,  # ('MG', 'N'): 2.50, Currently set to not bond as MG is usually an ion
    ("MG", "O"): 1.749
    + 0.1,  # ('MG', 'O'): 2.50, # Replaced by corresponding data from Huheey (double bond!)
    ("MG", "S"): 2.50,
    (
        "MN",
        "N",
    ): 0,  # ('MN', 'N'): 2.50, Currently set to not bond as MN is usually an ion
    (
        "MN",
        "O",
    ): 0,  # ('MN', 'O'): 2.50, Currently set to not bond as MN is usually an ion
    ("MN", "S"): 2.50,
    ("N", "N"): 1.46,
    ("N", "O"): 1.50,
    ("N", "P"): 1.75,
    ...
    (
        "N",
        "ZN",
    ): 0,  # ('N', 'ZN'): 2.50, Currently set to not bond as ZN is usually an ion
    ("NA", "F"): 1.830,
    (
        "NA",
        "O",
    ): 0.0,  # ('NA', 'O'): 2.70,  # Could not find evidence that this exists as a covalent bond.
    ("O", "O"): 1.55,
    ("O", "P"): 1.80,
    ("O", "S"): 1.60,
    ("O", "ZN"): 2.50,
    (
        "P",
        "P",
    ): 0,  # ('P', 'P'): 2.30, # Could not find evidence that this exists as a covalent bond.
    ("P", "S"): 2.10,
    ("S", "S"): 2.10,
    (
        "S",
        "ZN",
    ): 0.0,  # ('S', 'ZN'): 2.50, # Could not find evidence that this exists as a covalent bond.
    ("SE", "SE"): 2.95,
    # We add 0.1 to all values to take into account a small tolerance as the values below are usually at equilibrium.
    ("N", "SE"): 1.76
    + 0.1,  # S Sulfur-Nitrogen Compounds Part 3 Compounds with Sulfur of Oxidation Number IV
    ("C", "SE"): 1.98
    + 0.1,  # Table of Interatomic Distances and Configuration of Molecules and Ions, Special Publication No 11; Supplement 1956-1959, Special Publication No 18, Chemical Society, London 1958, 1965.
    ...
    ("O", "BR"): 1.905
    + 0.1,  # Kosmas AM. Theoretical Investigation of Halogen-Oxygen Bonding and Its Implications in Halogen Chemistry and Reactivity. Bioinorganic Chemistry and Applications. 2007;2007:46393. doi:10.1155/2007/46393.
    ...
    ("C", "BE"): 1.665
    + 0.1,  # The beryllium-carbon double bond: bonding in CH2Be(CO)n (n = 1, 2) K. K. Sunil, The Journal of Physical Chemistry 1993 97 (29), 7553-7555 DOI: 10.1021/j100131a026
    ("O", "BE"): 1.331 + 0.1,  # Huheey
    ("N", "BE"): 0,  # No source found
    ("H", "BE"): 1.343
    + 0.1,  # James Speight - Lange's Handbook of Chemistry - Seventeenth edition
